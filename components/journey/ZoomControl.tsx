...
export function ZoomControl({ onSetZoom, zoom }: Props) {
  function segClass(active: boolean) {
    return active ? `${SEG_BASE} bg-white text-brand` : `${SEG_BASE} bg-transparent text-muted`;
  }

  return (
    <div className="z-40 mx-auto mb-[clamp(16px,3vw,26px)] mt-[6px] inline-flex flex-none items-center gap-3 self-center rounded-full border border-white/60 bg-white/55 p-[6px_7px] shadow-[0_8px_30px_rgba(0,0,0,.12),inset_0_1px_0_rgba(255,255,255,.6)] backdrop-blur-[24px] backdrop-saturate-[1.8]">
